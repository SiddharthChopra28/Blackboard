...
class Blackboard():
    ...
    def right_click(self, pos):
        ...
        self.right_click_undo_box = pygame.Rect(pos[0], pos[1], self.box_width, box_len)
        self.right_click_change_pen_color_box = pygame.Rect(pos[0], pos[1]+ box_len, self.box_width, box_len)
        self.right_click_change_bg_color_box = pygame.Rect(pos[0], pos[1]+ 2*box_len, self.box_width, box_len)
        self.right_click_clear_box = pygame.Rect(pos[0], pos[1]+ 3*box_len, self.box_width, box_len)
        self.right_click_help_box = pygame.Rect(pos[0], pos[1]+ 4*box_len, self.box_width, box_len)

        self.right_click_undo_box_border = pygame.Rect(pos[0], pos[1], self.box_width, box_len)
        self.right_click_change_pen_color_box_border = pygame.Rect(pos[0], pos[1]+ box_len, self.box_width, box_len)
        self.right_click_change_bg_color_box_border = pygame.Rect(pos[0], pos[1]+ 2*box_len, self.box_width, box_len)
        self.right_click_clear_box_border = pygame.Rect(pos[0], pos[1]+ 3*box_len, self.box_width, box_len)
        self.right_click_help_box_border = pygame.Rect(pos[0], pos[1]+ 4*box_len, self.box_width, box_len)
